...
# %% Evaluation dataset registered in MLflow
EVAL_DATA = [
    {
...
def register_eval_dataset(eval_data=EVAL_DATA):
    """Creates the evaluation dataset in MLflow, tags it, and populates its records."""
...
def search_eval_traces():
    """Searches for traces tagged with the eval dataset name."""
